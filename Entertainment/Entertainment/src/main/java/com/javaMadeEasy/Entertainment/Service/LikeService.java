...
public class LikeService {
    ...
    public void removeLikeFromPost(Long postId, String userId) {
    ...
    public ResponseEntity<String> addPostLike(@PathVariable Long postId,@RequestParam int userId) {
        try {
    ...
    public ResponseEntity<String> removeLike(Long postId, String userId) {
        try {
            Like like =likeRepository.findByPostIdAndUserId(postId, userId).orElseThrow(() -> new EntityNotFoundException("Like not found"));
            likeRepository.delete(like);
